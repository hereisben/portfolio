...
export default function ComponentName() {
  ...
  return (
    <nav className="fixed z-10 top-6 left-0 right-0 flex justify-center items-center p-4">
      <div
        className={`flex items-center md:gap-3 p-2 rounded-full border border-white/10 bg-[#121212]/80 backdrop-blur-xl shadow-2xl overflow-x-auto md:overflow-visible max-w-[95vw] transition-transform duration-300 ease-out ${
